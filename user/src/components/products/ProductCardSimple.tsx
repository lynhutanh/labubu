...
export default function ProductCardSimple({
  ...
  useEffect(() => {
    // Removed: Wishlist status should be passed from parent to avoid N+1 queries.
    // If parent doesn't provide it, we initialize it as false.
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-purple-900/20 to-indigo-900/20">
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2 z-10">
          {badge && (
            <span
              className="px-3 py-1 text-white text-xs font-semibold rounded-full border border-white/30"
              style={{
                background:
                  badge === "Best Seller"
          ...
          {discount && (
            <span
              className="px-3 py-1 text-white text-xs font-semibold rounded-full border border-red-400/30"
              style={{
                background:
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/90 via-black/70 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          <div className="flex flex-col gap-2">
            ...
            >
              <button className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 rounded-lg font-semibold text-sm hover:from-purple-500 hover:to-indigo-500 transition-all flex items-center justify-center gap-2 shadow-lg shadow-purple-500/50">
      ...
      <div className="p-4 bg-gradient-to-b from-transparent to-black/20">
        ...
        <div className="mb-3">
          {isInStock ? (
            <span
              className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium text-green-200 border border-green-400/30"
              style={{
            ...
            <span
              className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium text-red-200 border border-red-400/30"
              style={{
