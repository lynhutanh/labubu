            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setQuantity(
                                                Math.max(1, Math.min(val, product.stock || 999)),
                                            );
                                        }}
                                        className="w-20 px-4 py-2 bg-white/10 border border-purple-500/30 rounded-lg text-white text-center"
                                    />
                                    <button
                                        onClick={() =>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    if ((window as any).openChatWithMessage) {
                                        (window as any).openChatWithMessage(message, {
                            ...
                            <button className="p-4 rounded-lg bg-white/10 border border-purple-500/30 text-purple-200 hover:bg-white/20 transition-all">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-purple-300">
                                            {t.home.bannerFeatures.premiumMaterial}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                ...
                {product.description && (
                    <motion.div
                        ...
                        className="galaxy-card rounded-2xl p-8 mb-12"
                    >
                        <h2 className="text-2xl font-bold text-white mb-4">
