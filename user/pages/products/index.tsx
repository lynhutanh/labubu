...
export default function ProductsPage() {
  ...
  // Removed heavy nebulaClouds animation for performance
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="0-200000" className="bg-gray-900">
                        0₫ - 200.000₫
                      </option>
                      <option value="200000-300000" className="bg-gray-900">
                        200.000₫ - 300.000₫
                      </option>
                      <option value="300000+" className="bg-gray-900">
                        Trên 300.000₫
                      </option>
                    </select>
                  </div>
