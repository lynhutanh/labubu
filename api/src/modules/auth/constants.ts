...
export const ACCOUNT_DELETED = "This account is deleted";
export const CANNOT_AUTHENTICATE = "Could not authenticated";
export const ACCOUNT_NOT_FOUND = "This account has not been found";
export const USERNAME_HAS_BEEN_TAKEN =
  "This username has been taken, please choose another one";
export const EMAIL_HAS_BEEN_TAKEN =
  "This email has been taken, please choose another one";
export const ACCOUNT_INACTIVE = "This account is de-activated";
